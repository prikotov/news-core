...
# В вызывающем проекте:
{project}/data/news-rss/YYYY/MM/DD/Source/
```
...
- Структура: `{project}/data/news-rss/YYYY/MM/DD/Source/`
- Каталог кэша определяется относительно cwd (каталог вызывающего проекта)
